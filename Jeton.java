...
public class Jeton {
    ...
    public static String[] tabInit = new String[NCASES];
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        do {
            ...
            System.out.println(sommeVoisins("B"));
            System.out.println(sommeVoisins("R"));
		...
		*/
            ...
            int sumR = 1;/*sommeVoisins(state,"R");*/
            int sumB = 0;/*sommeVoisins(state,"B");*/
    ...
    public static boolean jouer( String couleur, int val, int pos){
        if (pos>=0 && pos <NCASES && state[pos]=="___"){
            if (couleur=="B"){
                ...
                state[pos] = ANSI_BLUE_BACKGROUND + ANSI_WHITE + "B"+Integer.toString(val) + ANSI_RESET;
                StdDraw.filledCircle(val,pos,50);
                return true;
            }
            if (couleur=="R"){
     ...
     */
    /*RETURN INT!!!*/
    public static String sommeVoisins(String col){
        int k = getIdVide();
        int l = 0;
        ...
        if (k==0) {
            if (state[1].contains(col)==true)
                resultat=resultat+state[1];
            if (state[2].contains(col)==true)
                resultat=resultat+state[2];
            return resultat;
        }
